// src/components/products/ProductsHero/index.tsx
    ...
    <Box
      sx={{
        ...
        "&::after": {
          ...
          width: "100%",
          height: "100%",
          background: `url('/assets/images/products/hero-pattern.svg')`,
          opacity: 0.1,
          zIndex: 1,
        },
      }}
        ...
        <Grid container spacing={4} alignItems="center">
          <Grid item xs={12} md={12}>
            ...
            >
              ...
              >
                {intl.get("products.hero.subtitle")}
              </Typography>
              ...
              >
                {intl.get("products.hero.ctaButton")}
              </Button>
            </motion.div>
          </Grid>
